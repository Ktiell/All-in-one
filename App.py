...
def evaluate_expression(expr):
    try:
        # Replace mixed numbers like 3 1/2 with (3+1/2)
...
# --- Layout ---
st.sidebar.title("ðŸ“ Tape Measure Calculator")
st.sidebar.markdown("Enter measurements like `3 1/2 + 1 1/8` or use the buttons.")

display = st.sidebar.text_input(" ", st.session_state.expression, label_visibility="collapsed")
...
st.sidebar.markdown("### Fractions")
frac_row1 = st.sidebar.columns(5)
frac_row2 = st.sidebar.columns(5)
...
st.sidebar.checkbox("Show in feet & inches", key="use_feet")
